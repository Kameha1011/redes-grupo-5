...
class Packet:
    ...
    HEADER_FORMAT = "!III" # I = 4 bytes integer => 12 bytes header
    ...
    def to_bytes(self):
        ...
        info = self.compose_info_field()
        crc = zlib.crc32(info + self.seq_num + self.data)
        header = struct.pack(self.HEADER_FORMAT, info, self.seq_num, crc)
    ...
    def _compose_info_field(self):
        ...
        info |= (self.data_length & constants.PAYLOAD_LENGTH_FIELD_SIZE)
        return info
