...
Esta solución no es la más elegante desde el punto de vista arquitectónico, ya que idealmente el switch debería poder manejar este tráfico ARP directamente en el plano de datos sin involucrar al controlador. Sin embargo, dado que al iniciar la red no hay flujos instalados y el switch envía todo al controlador, el flooding controlado por el controller es suficiente para que el ARP Reply se genere y la tabla ARP de h2 se complete, permitiendo la comunicación subsiguiente.
